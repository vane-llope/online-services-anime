app.component('password-generator', {
    template:
        /*html*/
        `  <div class="containerPG containerG">
                    
        <h2>تولید پسورد تصادفی</h2>
        ...
        <div class="options">
            ...
            <input type="checkbox" checked v-model="checkedLowercase">
        </div>
        <div class="options">
            <label> شامل حروف بزرگ بشود</label>
            <input type="checkbox" checked v-model="checkedUppercase">

        </div>

        <div class="options">
            <label>شامل عدد بشود</label>
            <input type="checkbox" checked v-model="checkedNumbers">
        </div>
        <div class="options">
            <label> شامل نشانه ها بشود</label>
            <input type="checkbox" checked v-model="checkedSymbols">
        </div>
